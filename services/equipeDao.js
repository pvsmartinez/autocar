...
function cadastro(nome, especialidade, func1, func2, proximo_horario) {
	return "insert into equipe (nome, especialidade_id, id_func1, id_func2,proximo_horario) values ('"+nome+"', "+especialidade+", "+func1+", "+func2+", '"+proximo_horario+"')";
}
