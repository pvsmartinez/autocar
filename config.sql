...
CREATE TABLE ordem_de_servico(id int(11) auto_increment, equipe_id int(11), automovel_id int(11), data_emissao datetime, data_conclusao datetime, horario datetime, preco decimal(6,2), tipo int(1) not null default 0, revisao_id int(11) null, status int(1), especialidade_id int(11), descricao varchar(2047), primary key (id));
...
ALTER TABLE ordem_de_servico ADD INDEX (equipe_id) ,ADD FOREIGN KEY (equipe_id) REFERENCES equipe(id) ON DELETE CASCADE,ADD INDEX (automovel_id) ,ADD FOREIGN KEY (automovel_id) REFERENCES automovel(id) ON DELETE CASCADE,ADD INDEX (revisao_id) ,ADD FOREIGN KEY (revisao_id) REFERENCES revisao(id) ON DELETE CASCADE,ADD INDEX (especialidade_id) ,ADD FOREIGN KEY (especialidade_id) REFERENCES especialidade(id) ON DELETE CASCADE;
