...
ALTER TABLE equipe ADD INDEX (especialidade_id) ,ADD FOREIGN KEY (especialidade_id) REFERENCES especialidade(id),ADD INDEX (id_func1) ,ADD FOREIGN KEY (id_func1) REFERENCES usuario(id),ADD INDEX (id_func2) ,ADD FOREIGN KEY (id_func2) REFERENCES usuario(id);
...
ALTER TABLE usuario ADD INDEX (especialidade_id) ,ADD FOREIGN KEY (especialidade_id) REFERENCES especialidade(id);
