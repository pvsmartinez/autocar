...
CREATE TABLE equipe(id int(11) auto_increment, nome varchar(100), especialidade int(11), id_func1 int(11), id_func2 int(11), primary key (id));
...
ALTER TABLE automovel ADD INDEX (cliente_id) ,ADD FOREIGN KEY (cliente_id) REFERENCES usuario(id),ADD INDEX (modelo_id) ,ADD FOREIGN KEY (modelo_id) REFERENCES modelo_carro(id);
ALTER TABLE equipe ADD INDEX (especialidade) ,ADD FOREIGN KEY (especialidade) REFERENCES especialidade(id),ADD INDEX (id_func1) ,ADD FOREIGN KEY (id_func1) REFERENCES usuario(id),ADD INDEX (id_func2) ,ADD FOREIGN KEY (id_func2) REFERENCES usuario(id);
...
ALTER TABLE revisao ADD INDEX (modelo_id) ,ADD FOREIGN KEY (modelo_id) REFERENCES modelo_carro(id);
...
ALTER TABLE usuario ADD INDEX (especialidade) ,ADD FOREIGN KEY (especialidade) REFERENCES especialidade(id);
