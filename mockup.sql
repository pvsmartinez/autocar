...
insert into tipo_de_servico (nome,preco) values ('Conserto de parachoque','400');
insert into tipo_de_servico (nome,preco) values ('Conserto de motor','1200');
insert into tipo_de_servico (nome,preco) values ('Troca de embreagem','500');
truncate usuario;
